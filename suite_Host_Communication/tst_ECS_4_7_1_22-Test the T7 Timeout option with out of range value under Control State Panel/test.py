# -*- coding: utf-8 -*-
#Test the T7 Timeout option with out of range value under Control State Panel
import names
...
def main():
    ...
    T7_Timeout_invalid_value=jsondata["T7_Timeout_invalid_value"]
    ...
    snooze(2)
    type(waitForObject(names.eCSUI_Window),T7_Timeout_invalid_value)
