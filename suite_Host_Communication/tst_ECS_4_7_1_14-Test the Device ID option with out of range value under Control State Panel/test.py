# -*- coding: utf-8 -*-
#Test the Device ID option with out of range value under Control State Panel
import names
...
def main():
    ...
    Device_ID_invalid_value=jsondata["Device_ID_invalid_value"]
    ...
    snooze(2)
    type(waitForObject(names.eCSUI_Window),Device_ID_invalid_value)
